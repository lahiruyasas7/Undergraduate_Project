...
<li class="nav-item">
         <a class="nav-link active" href="employee_viewRatings.php">View Ratings</a>
    </li>
    <li class="nav-item">
...
<body>
    <div class="container">
        ...
        <h1 class="mt-3 mb-3"><?php echo $_SESSION['username'] ?></h1>
    	<div class="card">
    		<div class="card-header" color="blue">emplyee  </div>
    		<div class="card-body">
    			<div class="row">
