...
include "includes/company-review-sidebar.php";
...
<div class="card shadow mb-4" style="width: 100%">
    ...
    <div class="card-body" >
        ...
        $query = " SELECT * FROM `review_log` WHERE usertype='user' ORDER BY `time_stamp` DESC ";
            ...
            <table class="table table-bordered"  width="100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <input type="hidden" name="com_edit_id" value="<?php echo $row['rid']; ?>">
                        <button type="submit" name="com_del_btn" class="btn btn-outline-success btn-sm">Delete</button>
                        </td>
