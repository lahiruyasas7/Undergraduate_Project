...
<ul class="nav nav-tabs justify-content-center">
    ...
    <li class="nav-item">
         <a class="nav-link active" href="employee-company.php">Companies</a>
    </li>
            ...
            <table class="content-table" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <a type="button" class="btn btn-secondary" href="employee-comshowjobs.php" >View Jobs</a>
                              
                              <button type="button" class="btn btn-secondary" data-dismiss="modal">Reviews</button>
                         </div>
